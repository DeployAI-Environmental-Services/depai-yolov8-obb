...
class ImageProcessorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessImage = channel.unary_unary(
                ...
                response_deserializer=model__pb2.ImageResponse.FromString,
...
def add_ImageProcessorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=model__pb2.ImageResponse.SerializeToString,
            ),
    }
...
class ImageProcessor(object):
    ...
    def ProcessImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            model__pb2.ImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
